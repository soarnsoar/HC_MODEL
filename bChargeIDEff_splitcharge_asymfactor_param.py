...
class bChargeIDEff(PhysicsModel):
    ...
    def doParametersOfInterest(self):
        ...
        N_bplus_FAIL=self.dict_ymc["N_plus_FAIL"]
        ...
        _max=min(_bminus_max,_bplus_max)/2
        self.modelBuilder.doVar("SF0[1, 0,"+_max+"]")
        self.modelBuilder.doVar("dSF[0, -0.3,0.3]")
        ...
        ##---SF+/- = SF0(1+/- dSF)
        self.modelBuilder.factory_( 'expr::SF_bminus(\" @0 * (1. + @1) \", SF0,dSF')
        self.modelBuilder.factory_( 'expr::SF_bplus(\" @0 * (1. - @1) \", SF0,dSF')
